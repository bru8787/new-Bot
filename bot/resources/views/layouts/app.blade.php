            ...
            <div class="col-12 col-sm-3 col-xl-2 px-sm-2 px-0 bg-dark d-flex sticky-top">
                <div class="d-flex flex-sm-column flex-row flex-grow-1 align-items-center align-items-sm-start px-3 pt-2 text-white">
                    <a href="/" class="d-flex align-items-center pb-sm-3 mb-md-0 me-md-auto text-white text-decoration-none">
                        <span class="fs-5">Bot<span class=" ms-2 d-none d-sm-inline"><img src="{{ url('storage/images/bot-TG.jpg') }}" alt="hugenerd" width="28" height="28" class="rounded-circle"></span></span>
                    </a>
                    ...
                    <div class="dropdown py-sm-4 mt-sm-auto ms-auto ms-sm-0 flex-shrink-1">
                        <a href="#" class="d-flex align-items-center text-white text-decoration-none dropdown-toggle" id="dropdownUser1" data-bs-toggle="dropdown" aria-expanded="false">
                            <img src="{{ url('storage/images/bot-TG.jpg') }}" alt="hugenerd" width="28" height="28" class="rounded-circle">
