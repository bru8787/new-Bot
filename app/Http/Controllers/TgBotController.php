 ...
 */
class TgBotController extends SimpleEventHandler
{
    /**
     * @var int|string Username or ID of bot admin
     */
    public const ADMIN = "@brudr87"; // !!! Change this to your username !!!
...
// For users or bots
TgBotController::startAndLoop('bot.madeline', $settings);
